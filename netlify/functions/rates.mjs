...
// Default rate table from the Excel data
const DEFAULT_RATES = {
  AIR:  { drate:16.25, dratex:1.5, gdpi:1,    srate:25, sratex:3 },
  BAK1: { drate:9.75,  dratex:1,   gdpi:0.5,  srate:15, sratex:1 },
  BAK2: { drate:13,    dratex:1,   gdpi:0.5,  srate:20, sratex:2 },
  BAKP: { drate:9,     dratex:0,   gdpi:0.5,  srate:13, sratex:0 },
  BAL:  { drate:14.3,  dratex:1.5, gdpi:0.5,  srate:22, sratex:3 },
  BAS:  { drate:8.45,  dratex:1,   gdpi:0.5,  srate:13, sratex:2 },
  BEI:  { drate:32.5,  dratex:1.5, gdpi:1.5,  srate:50, sratex:3 },
  BLK:  { drate:32.5,  dratex:1.5, gdpi:1.5,  srate:50, sratex:3 },
  ...
  BTY:  { drate:9.75,  dratex:0.75,gdpi:0.5,  srate:15, sratex:1 },
  ...
  C5:   { drate:9.75,  dratex:1.5, gdpi:0.5,  srate:15, sratex:3 },
  ...
  COR:  { drate:13,    dratex:1.5, gdpi:0.5,  srate:20, sratex:3 },
  CRO:  { drate:26,    dratex:1.5, gdpi:1,    srate:45, sratex:3 },
  DEW:  { drate:16.25, dratex:1.5, gdpi:0.75, srate:25, sratex:3 },
  DOC:  { drate:11.7,  dratex:2.5, gdpi:0.75, srate:18, sratex:0 },
  ...
  LTR:  { drate:9.75,  dratex:0.75,gdpi:0.75, srate:15, sratex:1 },
  ...
  SET:  { drate:25,    dratex:1.5, gdpi:1,    srate:35, sratex:5 },
  SPEC: { drate:16.25, dratex:2.5, gdpi:4,    srate:25, sratex:5 },
  SPL:  { drate:13,    dratex:2.5, gdpi:1,    srate:20, sratex:5 },
  SPO:  { drate:16.25, dratex:2.5, gdpi:1,    srate:25, sratex:3 },
  STR:  { drate:22.75, dratex:1.5, gdpi:2,    srate:35, sratex:3 },
  TSU:  { drate:16.25, dratex:1.5, gdpi:0.75, srate:25, sratex:3 },
  TVA:  { drate:32.5,  dratex:1.5, gdpi:1.5,  srate:50, sratex:3 },
  WAI:  { drate:16.25, dratex:1.5, gdpi:1,    srate:25, sratex:1.5 },
  WCH:  { drate:16.25, dratex:1,   gdpi:1,    srate:25, sratex:1.5 },
  ...
  WTV:  { drate:32.5,  dratex:1,   gdpi:2,    srate:50, sratex:1.5 },
  WLO2: { drate:40,    dratex:1,   gdpi:5,    srate:60, sratex:1.5 },
...
export default async (req) => {
  ...
  if (req.method === 'GET') {
    // Try to get stored rates, fall back to defaults
    try {
